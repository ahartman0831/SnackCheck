...
- PR #19 contains `classroom-use-v2` routing. Its dry run produced 95 `AUTO_EVIDENCE`, 6 `HUMAN_EXCEPTION`, and 388 `DEPRIORITIZED` records. Migration `0032` is not yet applied to staging and PR #19 is not yet merged.
